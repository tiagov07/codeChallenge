...
// 32-bit integers, they have 32 bits in their binary representation. The preceding zeros in
// other cases don't matter, so they are omitted. Here, however, it does make a difference.
