...
// beautiful?". Mary believes that a person is loved if and only if
// he/she is both young and beautiful, but this is quite a depressing
// thought, so she wants to put her belief to the test.

// Knowing whether a person is young, beautiful and loved, find out if
// they contradict Mary's belief.

// A person contradicts Mary's belief if one of the following statements
// is true:
...
// For young = true, beautiful = false, and loved = true, the output
// should be
